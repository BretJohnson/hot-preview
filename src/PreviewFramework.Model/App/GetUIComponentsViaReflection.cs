...
public class GetUIComponentsViaReflection : UIComponentsManagerBuilderBase<UIComponentReflection, PreviewReflection>
{
        ...
        foreach (Type type in types)
        {
            ...
            if (CanBeAutoGeneratedPreview(type))
            {
                ...
                if ((uiComponent is null || uiComponent.Previews.Count == 0) && CanBeAutoGeneratedPreview(type))
                {
                    ...
                    PreviewClassReflection preview = new PreviewClassReflection(type, isAutoGenerated: true);
                    AddPreview(preview);
                }
            }
        }
    ...
    private UIComponentReflection GetOrAddUIComponent(Type type, UIComponentKind? kind = null)
    {
        string? name = type.FullName;
        if (name == null) throw new ArgumentException("Type must have a FullName", nameof(type));
        ...
        if (component is null)
        {
            ...
            AddOrUpdateUIComponent(component);
        }
