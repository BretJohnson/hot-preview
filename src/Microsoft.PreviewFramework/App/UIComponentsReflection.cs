...
public class UIComponentsReflection : UIComponentsBase<UIComponentReflection, UIPreviewReflection>
{
    public void AddFromAssembly(Assembly assembly)
    {
        ...
        foreach (Type type in types)
        {
            ...
            {
                AddPreview(new UIPreviewClassReflection(typePreviewAttribute, type));
            }
            ...
            if (CanBeAutoGeneratedPreview(type))
            {
                ...
                if ((uiComponent == null || uiComponent.Previews.Count == 0) && CanBeAutoGeneratedPreview(type))
                {
                    ...
                    var preview = new UIPreviewClassReflection(type, isAutoGenerated: true);
                    AddPreview(preview);
                }
            }
        }
    ...
    public void AddPreview(UIPreviewReflection preview)
    {
